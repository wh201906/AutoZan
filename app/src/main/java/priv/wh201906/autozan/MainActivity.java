...
public class MainActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        delayView = findViewById(R.id.Main_ZanTimeView);
            ...
            public void onClick(View v)
            {
                try
                {
                    ...
                    if (settings.contains("LockTime"))
                    {
                        ...
                        app.LogPrintLine(settings.getInt("LockTime", 15000) == Integer.MAX_VALUE ? "无需恢复" : "已恢复锁屏时间为" + (settings.getInt("LockTime", 15000) / 1000) + "秒");
                    ...
                    else
                    {
                        ...
                        app.LogPrintLine(settings.getInt("LockTime", 15000) == Integer.MAX_VALUE ? "无需设置" : "已保存锁屏时间为" + (settings.getInt("LockTime", 15000) / 1000) + "秒并设置为永不锁屏");
                    }
        ...
        SeekBar seekbar = findViewById(R.id.Main_ZanSeekBar);
        seekbar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener()
        {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser)
            {
                delayView.setText(getString(R.string.Main_interval) + (progress2time(progress) / 1000f) + "秒");
        ...
        delayView.setText(getString(R.string.Main_interval) + (progress2time(seekbar.getProgress()) / 1000f) + "秒");
